...
const FEATURED = [
  {
    id: 1,
    name: 'Project Alpha',
    creator: 'CS/2022 Team',
    desc: 'An AI-powered campus navigation system built entirely by CS students at Caritas.',
  ...
  },
  {
    id: 2,
    name: 'EduTrack',
    creator: 'CS/2021 Final Year',
    desc: 'Smart student management platform with real-time tracking and analytics dashboard.',
    tags: ['Next.js', 'Convex', 'Node.js'],
    color: 'pink',
    link: '#',
  },
  {
